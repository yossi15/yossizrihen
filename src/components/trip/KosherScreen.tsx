    ...
    <div className="space-y-3.5 px-4 pb-6 pt-1">
      ...
      <section className="trip-card p-4">
        ...
        <p className="mt-1 text-xs leading-relaxed text-[var(--t-muted)]">
          רוב הכשרות בתאילנד עוברת דרך חב&quot;ד, אבל יש גם מסעדות ישראליות
          עצמאיות — בעיקר בפוקט ובבנגקוק. מיקומים, שעות והשגחה משתנים בין
          עונות, אז תמיד לאמת בטלפון לפני שנוסעים, ולהירשם מראש לסעודות חג.
        </p>
